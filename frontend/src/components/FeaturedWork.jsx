...
const FeaturedWork = () => {
  return (
    <section id="work" className="relative bg-black py-32 overflow-hidden">
      {/* Section Header */}
      <div className="max-w-[1920px] mx-auto px-6 lg:px-12 mb-20">
        <motion.div
        ...
        >
          ...
          <p className="text-gray-400 max-w-md leading-relaxed">
            A curated selection of my finest work spanning commercials, documentaries, music videos, and narrative films.
          </p>
        </motion.div>
      </div>

      {/* Projects Grid */}
      <div className="max-w-[1920px] mx-auto px-6 lg:px-12 space-y-32">
